...
it('check_in', () => {
   ...
   cy.wait(5000)
    ...
    cy.wait(5000)
     ...
     cy.wait(2000)
     cy.get("[class='p-dropdown-item-label']").eq(1).click()// Select User name from dropdown
     ...
     cy.get("[class='w-full placeholder:text-[#2C363F] p-inputtextarea p-inputtext p-component']").type("Check-in Notes")// Add notes
     cy.wait(5000)
