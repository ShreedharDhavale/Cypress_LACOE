...
it('Reservation_Location', () => {
   ...
   cy.wait(5000)
    ...
    cy.wait(5000)
     ...
     cy.visit("https://uat-assetfusion360-lacoe.hexalytics.ai/admin/reserve/create");// Navigate to add reserve page
     cy.wait(2000)
     cy.get("[class='p-dropdown-trigger']").eq(2).click()// Click on reserve type dropdown button
     cy.wait(2000)
     cy.get("[class='p-dropdown-item-label']").eq(1).click()// Select on reserve type 
     cy.wait(2000)
     cy.get("[class='p-dropdown-trigger']").eq(3).click()// Click on location dropdown button
     cy.wait(2000)
     cy.get("[class='p-dropdown-item-label']").eq(0).click()// Select on location
     cy.wait(2000)
