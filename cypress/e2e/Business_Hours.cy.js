...
cy.wait(2000)   
cy.get("[class='w-full p-inputtext p-component']").type("Test Business Hours 1")// Add Business Hours "Title"
...
cy.wait(2000)
cy.get("[class='w-full p-inputtext p-component']").type(userdata.Holidays_Title)// Add holidays "Title"
cy.wait(2000)
cy.get("[class='p-datepicker-trigger p-button p-component p-button-icon-only']").click()// Click on "Date picker"
cy.get("[data-pc-section='daylabel']").eq(25).click({force: true})// Select date
