...
cy.get("[class='placeholder:text-[#828A91] placeholder:text-[13px] w-full h-10 p-inputtext p-component']").eq(0).type(userdata.Depreciation_name)// Add Depreciation name
...
cy.wait(4000)
cy.get("[class='p-icon p-multiselect-close-icon']").click()//Click on "Manufacturer" dropdown close icon
cy.wait(4000)
...
cy.wait(2000)
cy.get("[class='p-multiselect-close p-link']").click()//Click on "Model" dropdown close icon
cy.wait(2000)
cy.get("[data-pc-section='trigger']").eq(4).click()
cy.contains('.p-dropdown-item-label', 'Straight Line Method').click();// Select "Depreciation Method" from dropdown
cy.wait(2000)
cy.get("[class='placeholder:text-[#828A91] placeholder:text-[13px] w-full h-10 p-inputtext p-component']").eq(0).type(userdata.Depreciate_Percentage)// Add Depreciate Percentage
cy.get("[class='p-dropdown-trigger']").eq(2).click()// Click on "Depreciation Frequency" dropdown button
