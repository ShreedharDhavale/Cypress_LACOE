...
Cypress.on('window:before:load', (win) => {
  ...
  it('Manage_role', () => {
    ...
    cy.wait(2000)
    cy.get("[class='placeholder:text-[#828A91] placeholder:text-[13px] w-full h-10 p-inputtext p-component']").type(userdata.Role_field)// Add role field
    cy.get("[class='p-inputtextarea p-inputtext p-component']").type(userdata.Role_description)// Add description
