...
it('Transfer', () => {
   ...
   cy.wait(5000)
    ...
    cy.wait(5000)
     ...
     cy.get("[class='p-radiobutton-input']").eq(1).click()// Click on "Site and Location/Room" radio button
     ...
     cy.get("[class='p-dropdown-trigger']").eq(2).click()// Click on Transfer to Site dropdown button
     cy.get("[class='p-dropdown-item-label']").eq(0).click()// Select Transfer to Site from dropdown
     cy.get("[class='p-dropdown-trigger']").eq(3).click()// Click on Transfer to Location/Room dropdown button
